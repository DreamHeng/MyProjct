        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <form action="javascript:;" class="form-inline" method="get">
                    ...
                    <input type="text" class="form-control" name="min" placeholder="最低评分" value="${min}">
                    <input type="text" class="form-control" name="max" placeholder="最高评分" value="${max}">
                    <button class="btn btn-default"><i class="fa fa-search">搜索</i></button>
                </form>
            </div>
        </div>
